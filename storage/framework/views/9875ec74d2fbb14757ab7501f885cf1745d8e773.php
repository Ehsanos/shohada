...
} elseif ($_instance->childHasBeenRendered('lO61wLH')) {
    $componentId = $_instance->getRenderedChildComponentId('lO61wLH');
    $componentTag = $_instance->getRenderedChildComponentTagName('lO61wLH');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('lO61wLH');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('lO61wLH', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
 <?php echo $__env->renderComponent(); ?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH D:\projectFolder\shohada\vendor\filament\filament\src\/../resources/views/components/layouts/card.blade.php ENDPATH**/ ?>