...
} elseif ($_instance->childHasBeenRendered('ymEEtxL')) {
    $componentId = $_instance->getRenderedChildComponentId('ymEEtxL');
    $componentTag = $_instance->getRenderedChildComponentTagName('ymEEtxL');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ymEEtxL');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('ymEEtxL', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('vnF4TMt')) {
    $componentId = $_instance->getRenderedChildComponentId('vnF4TMt');
    $componentTag = $_instance->getRenderedChildComponentTagName('vnF4TMt');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('vnF4TMt');
} else {
    $response = \Livewire\Livewire::mount('filament.core.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('vnF4TMt', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH D:\projectFolder\shohada\vendor\filament\filament\src\/../resources/views/components/topbar.blade.php ENDPATH**/ ?>