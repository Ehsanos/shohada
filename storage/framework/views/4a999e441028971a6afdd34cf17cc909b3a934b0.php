...
} elseif ($_instance->childHasBeenRendered('9z0KZtv')) {
    $componentId = $_instance->getRenderedChildComponentId('9z0KZtv');
    $componentTag = $_instance->getRenderedChildComponentTagName('9z0KZtv');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('9z0KZtv');
} else {
    $response = \Livewire\Livewire::mount('counter', []);
    $html = $response->html();
    $_instance->logRenderedChild('9z0KZtv', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </span>
...
<?php /**PATH D:\projectFolder\shohada\resources\views/layouts/master.blade.php ENDPATH**/ ?>