...
} elseif ($_instance->childHasBeenRendered('SjWpv9M')) {
    $componentId = $_instance->getRenderedChildComponentId('SjWpv9M');
    $componentTag = $_instance->getRenderedChildComponentTagName('SjWpv9M');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('SjWpv9M');
} else {
    $response = \Livewire\Livewire::mount('counter', []);
    $html = $response->html();
    $_instance->logRenderedChild('SjWpv9M', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </span>
