...
} elseif ($_instance->childHasBeenRendered('4KVxtsq')) {
    $componentId = $_instance->getRenderedChildComponentId('4KVxtsq');
    $componentTag = $_instance->getRenderedChildComponentTagName('4KVxtsq');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('4KVxtsq');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('4KVxtsq', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
 <?php echo $__env->renderComponent(); ?>
